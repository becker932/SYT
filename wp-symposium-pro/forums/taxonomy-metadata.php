 ...
 */
function wps_add_term_meta($term_id, $meta_key, $meta_value, $unique = false) {
 ...
 * @return bool False for failure. True for success.
 */
function wps_delete_term_meta($term_id, $meta_key, $meta_value = '') {
 ...
 *  is true.
 */
function wps_get_term_meta($term_id, $key, $single = false) {
 ...
 */
function wps_update_term_meta($term_id, $meta_key, $meta_value, $prev_value = '') {
