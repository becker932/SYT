...
(function($, _, window, document, undefined) {
	...
	ThemifyPageBuilder = {
		...
		moduleOptionsBinding: function ( $context) {
			...
			$context.find('input[data-binding], textarea[data-binding], select[data-binding]').change(function () {
				var logic = false,
		...
		renderColumn: function( $column, sendData ) {
			...
			return $.ajax({
				...
				success: function( data ) {
					...
					$('.current_selected_column').get(0).outerHTML = $newColumn.get(0).outerHTML;
